...
class Page:
	"""pages where we like to show profiles"""

	def __init__(self):
		self.profile_pages = {
		'featured idea' : u"""Jmorgan_(WMF)/sandbox/"""
		,
		'featured person' : u"""IdeaLab/Introductions/Featured/"""
		}

	def getPage(self, pg_type):
		if pg_type in self.profile_pages:
			return self.profile_pages[pg_type]
		else: print "unknown page type"
